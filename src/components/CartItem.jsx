...
const CartItem = ({id, imageUrl,  name, onRemoveItem, onMinusItem, onPlusItem, totalCount, totalPrice}) => {
  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <div onClick={handlerMinusItem} className="button button--outline button--circle cart__item-count-minus">
        ...
        <b>{totalCount}</b>
        <div onClick={handlerPlusItem} className="button button--outline button--circle cart__item-count-plus">
          <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="cart__item-remove">
        <Button onClick={handlerRemoveItem} className="button--circle" outline>
          <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
